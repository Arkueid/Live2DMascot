...
GLWidget::GLWidget() 
{
	...
	connect(this, SIGNAL(shouldQuit()), this, SLOT(completeQuit()));
}
...
void GLWidget::SetupUI()
{
	...
	rightMenu->setStyleSheet("QMenu {font-size: 14px; background-color: white; padding-top: 8px; padding-bottom: 8px; border: 1px solid rgb(214, 214, 214); padding: 4px; color: black;} QMenu::item::selected{background-color: rgba(50, 150, 240, 200); color: white;} QMenu::item {padding: 0 0 0 20px; margin-left: 4px; margin-right: 4px;color: rgb(90, 90, 90);} QMenu::indicator{width: 13px;} QMenu::item:checked, QMenu::item:unchecked{padding-left: 7;}");
