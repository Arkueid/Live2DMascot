...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.15.2"
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.15.2/QtBluetooth"
    )
    ...
    _populate_Bluetooth_target_properties(RELEASE "Qt5Bluetooth.dll" "Qt5Bluetooth.lib" TRUE)



    _populate_Bluetooth_target_properties(DEBUG "Qt5Bluetoothd.dll" "Qt5Bluetoothd.lib" TRUE)
