...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.15.2"
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.15.2/QtRemoteObjects"
    )
    ...
    _populate_RemoteObjects_target_properties(RELEASE "Qt5RemoteObjects.dll" "Qt5RemoteObjects.lib" TRUE)



    _populate_RemoteObjects_target_properties(DEBUG "Qt5RemoteObjectsd.dll" "Qt5RemoteObjectsd.lib" TRUE)
