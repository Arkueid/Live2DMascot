...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.15.2"
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.15.2/Qt3DRender"
    )
    ...
    _populate_3DRender_target_properties(RELEASE "Qt53DRender.dll" "Qt53DRender.lib" TRUE)



    _populate_3DRender_target_properties(DEBUG "Qt53DRenderd.dll" "Qt53DRenderd.lib" TRUE)
