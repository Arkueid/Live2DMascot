...
set(Qt5VulkanSupport_VERSION_STRING 5.15.2)
...
macro(_populate_VulkanSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_implib "${_qt5VulkanSupport_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_VulkanSupport_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::VulkanSupport)
    ...
    set(Qt5VulkanSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.15.2"
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.15.2/QtVulkanSupport"
    )
    ...
    foreach(_module_dep ${_Qt5VulkanSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5VulkanSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_VulkanSupport_process_prl_file(
            "${_qt5VulkanSupport_install_prefix}/lib/Qt5VulkanSupportd.prl" DEBUG
            _Qt5VulkanSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5VulkanSupport_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_VulkanSupport_process_prl_file(
            "${_qt5VulkanSupport_install_prefix}/lib/Qt5VulkanSupport.prl" RELEASE
    ...
    _populate_VulkanSupport_target_properties(RELEASE "Qt5VulkanSupport.lib" "" TRUE)



    _populate_VulkanSupport_target_properties(DEBUG "Qt5VulkanSupportd.lib" "" TRUE)
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::VulkanSupport AND NOT TARGET Qt::VulkanSupport)
