...
if (NOT TARGET Qt5::Location)
    ...
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/QtLocation/5.15.2"
        "${_qt5Location_install_prefix}/include/QtLocation/5.15.2/QtLocation"
    )
    ...
    set_property(TARGET Qt5::Location
                 ...
                 geoservices_esri;geoservices_here;geoservices_itemsoverlay;geoservices_mapbox;geoservices_osm;location-labs-plugin)
    set_property(TARGET Qt5::Location
    ...
    _populate_Location_target_properties(RELEASE "Qt5Location.dll" "Qt5Location.lib" TRUE)



    _populate_Location_target_properties(DEBUG "Qt5Locationd.dll" "Qt5Locationd.lib" TRUE)
