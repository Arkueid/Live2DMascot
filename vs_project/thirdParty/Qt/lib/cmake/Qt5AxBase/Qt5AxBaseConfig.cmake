...
set(Qt5AxBase_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::AxBase)
    ...
    set(Qt5AxBase_PRIVATE_INCLUDE_DIRS
        "${_qt5AxBase_install_prefix}/include/ActiveQt/5.15.2"
        "${_qt5AxBase_install_prefix}/include/ActiveQt/5.15.2/ActiveQt"
    )
    ...
    foreach(_module_dep ${_Qt5AxBase_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5AxBase_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_AxBase_process_prl_file(
            "${_qt5AxBase_install_prefix}/lib/Qt5AxBased.prl" DEBUG
            _Qt5AxBase_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5AxBase_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_AxBase_process_prl_file(
            "${_qt5AxBase_install_prefix}/lib/Qt5AxBase.prl" RELEASE
    ...
    _populate_AxBase_target_properties(RELEASE "Qt5AxBase.lib" "" TRUE)



    _populate_AxBase_target_properties(DEBUG "Qt5AxBased.lib" "" TRUE)
