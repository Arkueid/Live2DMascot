...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/include/QtGamepad/5.15.2"
        "${_qt5Gamepad_install_prefix}/include/QtGamepad/5.15.2/QtGamepad"
    )
    ...
    _populate_Gamepad_target_properties(RELEASE "Qt5Gamepad.dll" "Qt5Gamepad.lib" TRUE)



    _populate_Gamepad_target_properties(DEBUG "Qt5Gamepadd.dll" "Qt5Gamepadd.lib" TRUE)
