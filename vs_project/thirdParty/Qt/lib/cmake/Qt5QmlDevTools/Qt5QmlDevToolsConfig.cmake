...
set(Qt5QmlDevTools_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/QtQml/5.15.2"
        "${_qt5QmlDevTools_install_prefix}/include/QtQml/5.15.2/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5QmlDevTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5QmlDevTools_FIND_VERSION_EXACT}
    ...
    _populate_QmlDevTools_target_properties(RELEASE "Qt5QmlDevTools.lib" "" TRUE)

    if (EXISTS "${_qt5QmlDevTools_install_prefix}/lib/Qt5QmlDevToolsd.lib" )
        _populate_QmlDevTools_target_properties(DEBUG "Qt5QmlDevToolsd.lib" "" TRUE)
    endif()
