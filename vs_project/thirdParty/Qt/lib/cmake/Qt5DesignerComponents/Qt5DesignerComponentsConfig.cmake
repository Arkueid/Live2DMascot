...
set(Qt5DesignerComponents_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    set(Qt5DesignerComponents_PRIVATE_INCLUDE_DIRS
        "${_qt5DesignerComponents_install_prefix}/include/QtDesignerComponents/5.15.2"
        "${_qt5DesignerComponents_install_prefix}/include/QtDesignerComponents/5.15.2/QtDesignerComponents"
    )
    ...
    foreach(_module_dep ${_Qt5DesignerComponents_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5DesignerComponents_FIND_VERSION_EXACT}
    ...
    _populate_DesignerComponents_target_properties(RELEASE "Qt5DesignerComponents.dll" "Qt5DesignerComponents.lib" TRUE)



    _populate_DesignerComponents_target_properties(DEBUG "Qt5DesignerComponentsd.dll" "Qt5DesignerComponentsd.lib" TRUE)
